...
| P0 | 03, 04 | ✅ **已完成** — 管理端会话列表/详情重构为嵌套结构，新增 8 个测试 | 已修复 |
| P0 | 05, 06, 07 | ✅ **已完成** — 账单列表响应修复、紧急停止移除 failedSessions/加 chargingSessions、队列 move 加 targetZone，新增 9 个测试 | 已修复 |
| P1 | 02, 03 | ✅ **已完成** — 排队取消/确认拒绝响应添加 `"bill": null` | 已修复 |
| P1 | 04 | ✅ **已完成** — 停止充电响应添加 `electricityDetails` | 已修复 |
